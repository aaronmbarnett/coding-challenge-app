    ...
    <div class="space-y-6 lg:col-span-2">
      ...
      <div class="rounded-lg bg-white p-6 shadow">
        <div class="mb-4 flex items-center justify-between">
          ...
          <button class="text-sm text-blue-600 hover:text-blue-500"> + Add Test Case </button>
        </div>
                ...
                {#if testCase.kind === 'io'}
                  <div class="mt-2 grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <code class="mt-1 block bg-gray-50 p-2">{testCase.input}</code>
                    </div>
                    <div>
                      <span class="font-medium">Expected:</span>
                      <code class="mt-1 block bg-gray-50 p-2">{testCase.expectedOutput}</code>
                    </div>
                  </div>
                {/if}
              </div>
